...
public class Face_detection {
    ...
    public static void main(String[] args) {
        Face_detection obj = new Face_detection();
        obj.createArraylists("/media/shree/College/Sem_4/OOPS/OOPS_project/Image_dataset/Logs.txt");
        obj.train();
//        obj.e.read("/media/shree/College/Sem_4/OOPS/OOPS_project/Models/LBPH_first_success.dat");
        Mat img = Imgcodecs.imread("/media/shree/College/Sem_4/OOPS/OOPS_project/Image_dataset/test.jpeg");
        Mat resizeimage = new Mat();
        Size scaleSize = new Size(1024,1024);
        Imgproc.resize(img, resizeimage, scaleSize , 0, 0, INTER_AREA);
        ...
        obj.save("/media/shree/College/Sem_4/OOPS/OOPS_project/Models/LBPH.dat");
    }
}
